...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($action === 'add_layout_node') {
            ...
            $allowed=['on_open','before_save','after_save','before_delete','after_delete','field_changed'];
...
$eventLabels=['on_open'=>'Beim Öffnen','before_save'=>'Vor dem Speichern','after_save'=>'Nach dem Speichern','before_delete'=>'Vor dem Löschen','after_delete'=>'Nach dem Löschen','field_changed'=>'Feld geändert'];
