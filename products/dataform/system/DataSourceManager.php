...
{
    private const DRIVERS = ['mysql','sqlite','csv','oracle'];
    ...
    public static function fromPost(array $input): array
    {
        ...
        if($driver==='mysql'){
            ...
            if($config['host']===''||$config['database']===''||$config['username']===''){
                throw new RuntimeException('Für MySQL/MariaDB sind Host, Datenbank und Benutzer erforderlich.');
            }
            ...
            $config=[
                ...
                'service_name'=>trim((string)($input['service_name']??'FREEPDB1')),
                'username'=>trim((string)($input['username']??'')),
