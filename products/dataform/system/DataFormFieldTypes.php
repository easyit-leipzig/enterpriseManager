...
final class DataFormFieldTypeRegistry
{
    ...
    public static function all(): array
    {
        ...
        $types=[
            'text'=>self::d('Text','Text','string','text',['mysql'=>'VARCHAR(255)','sqlite'=>'TEXT','oracle'=>'VARCHAR2(255)','csv'=>'string']),
            'textarea'=>self::d('Mehrzeiliger Text','Text','string','textarea',['mysql'=>'TEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'string']),
            'richtext'=>self::d('Formatierter Text','Text','string','richtext',['mysql'=>'LONGTEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'string']),
            'markdown'=>self::d('Markdown','Text','string','markdown',['mysql'=>'LONGTEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'string']),
            'integer'=>self::d('Ganzzahl','Zahlen','integer','number',['mysql'=>'BIGINT','sqlite'=>'INTEGER','oracle'=>'NUMBER(19)','csv'=>'integer'],['step'=>'1']),
            'number'=>self::d('Zahl','Zahlen','number','number',['mysql'=>'DECIMAL(20,6)','sqlite'=>'REAL','oracle'=>'NUMBER(20,6)','csv'=>'number'],['step'=>'any']),
            'decimal'=>self::d('Dezimalzahl','Zahlen','decimal','number',['mysql'=>'DECIMAL(20,6)','sqlite'=>'NUMERIC','oracle'=>'NUMBER(20,6)','csv'=>'decimal'],['precision'=>20,'scale'=>6,'step'=>'0.000001']),
            'currency'=>self::d('Währung','Zahlen','decimal','number',['mysql'=>'DECIMAL(20,4)','sqlite'=>'NUMERIC','oracle'=>'NUMBER(20,4)','csv'=>'decimal'],['precision'=>20,'scale'=>4,'currency'=>'EUR','step'=>'0.01']),
            'percentage'=>self::d('Prozentwert','Zahlen','decimal','number',['mysql'=>'DECIMAL(9,4)','sqlite'=>'NUMERIC','oracle'=>'NUMBER(9,4)','csv'=>'decimal'],['precision'=>9,'scale'=>4,'min'=>0,'max'=>100,'step'=>'0.01']),
            'boolean'=>self::d('Ja/Nein','Auswahl und Beziehungen','boolean','checkbox',['mysql'=>'TINYINT(1)','sqlite'=>'INTEGER','oracle'=>'NUMBER(1)','csv'=>'boolean']),
            'checkbox'=>self::d('Kontrollkästchen','Auswahl und Beziehungen','boolean','checkbox',['mysql'=>'TINYINT(1)','sqlite'=>'INTEGER','oracle'=>'NUMBER(1)','csv'=>'boolean']),
            'date'=>self::d('Datum','Datum und Zeit','date','date',['mysql'=>'DATE','sqlite'=>'TEXT','oracle'=>'DATE','csv'=>'date']),
            'time'=>self::d('Uhrzeit','Datum und Zeit','time','time',['mysql'=>'TIME','sqlite'=>'TEXT','oracle'=>'VARCHAR2(8)','csv'=>'time']),
            'datetime'=>self::d('Datum und Uhrzeit','Datum und Zeit','datetime','datetime-local',['mysql'=>'DATETIME','sqlite'=>'TEXT','oracle'=>'TIMESTAMP','csv'=>'datetime']),
            'email'=>self::d('E-Mail','Kontakt und Verweise','email','email',['mysql'=>'VARCHAR(320)','sqlite'=>'TEXT','oracle'=>'VARCHAR2(320)','csv'=>'string']),
            'phone'=>self::d('Telefonnummer','Kontakt und Verweise','string','tel',['mysql'=>'VARCHAR(64)','sqlite'=>'TEXT','oracle'=>'VARCHAR2(64)','csv'=>'string']),
            'url'=>self::d('URL','Kontakt und Verweise','url','url',['mysql'=>'TEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'string']),
            'link'=>self::d('Link','Kontakt und Verweise','json','link',['mysql'=>'LONGTEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'json'],['target'=>'_self']),
            'select'=>self::d('Auswahlliste','Auswahl und Beziehungen','string','select',['mysql'=>'VARCHAR(255)','sqlite'=>'TEXT','oracle'=>'VARCHAR2(255)','csv'=>'string']),
            'multiselect'=>self::d('Mehrfachauswahl','Auswahl und Beziehungen','json','multiselect',['mysql'=>'LONGTEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'json']),
            'tags'=>self::d('Schlagwörter','Auswahl und Beziehungen','json','tags',['mysql'=>'LONGTEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'json']),
            'lookup'=>self::d('Datensatz-Auswahl','Auswahl und Beziehungen','string','lookup',['mysql'=>'BIGINT','sqlite'=>'INTEGER','oracle'=>'NUMBER(19)','csv'=>'string']),
            'multi_lookup'=>self::d('Mehrfach-Datensatz-Auswahl','Auswahl und Beziehungen','json','multi_lookup',['mysql'=>'LONGTEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'json']),
            'derived_multienum'=>self::d('Abgeleitete Mehrfachauswahl','Auswahl und Beziehungen','csv','derived_multienum',['mysql'=>'TEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'string']),
            'json'=>self::d('JSON','Strukturierte Daten','json','json',['mysql'=>'JSON','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'json'],['pretty'=>true]),
            'uuid'=>self::d('UUID','Strukturierte Daten','uuid','text',['mysql'=>'CHAR(36)','sqlite'=>'TEXT','oracle'=>'VARCHAR2(36)','csv'=>'string']),
            'coordinates'=>self::d('Koordinaten','Strukturierte Daten','json','coordinates',['mysql'=>'LONGTEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'json']),
            'file'=>self::d('Datei','Dateien und Medien','media','file',['mysql'=>'LONGTEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'json'],self::mediaDefaults('application/pdf,text/plain,text/csv,application/zip,application/json,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')),
            'image'=>self::d('Bild','Dateien und Medien','media','file',['mysql'=>'LONGTEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'json'],self::mediaDefaults('image/jpeg,image/png,image/webp,image/gif')),
            'color'=>self::d('Farbe','Spezialfelder','color','color',['mysql'=>'CHAR(7)','sqlite'=>'TEXT','oracle'=>'VARCHAR2(7)','csv'=>'string']),
            'computed'=>self::d('Berechnetes Feld','Spezialfelder','computed','text',['mysql'=>'TEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'string'],['template'=>'']),
            'hidden'=>self::d('Verstecktes Feld','Spezialfelder','string','hidden',['mysql'=>'TEXT','sqlite'=>'TEXT','oracle'=>'CLOB','csv'=>'string']),
            'password'=>self::d('Passwort / Geheimwert','Spezialfelder','secret','password',['mysql'=>'VARCHAR(255)','sqlite'=>'TEXT','oracle'=>'VARCHAR2(255)','csv'=>'string']),
        ];
        return $types;
    }
