# HF76-FIX4 – zentrale Button-Registry

Alle Titel stammen zentral aus `system/ui/ButtonRegistry.php`. Lokale `title`-/`aria-label`-Texte sind nicht maßgeblich.

| Schlüssel | Zentraler Titel | Bild | Kontexttitel |
|---|---|---|---|
| `neu` | Neu anlegen | `assets/img/neu.png` | `dataform` → Neues DataForm anlegen<br>`record` → Neuen Datensatz anlegen<br>`project` → Neues Projekt anlegen<br>`relation` → Neue Beziehung anlegen |
| `bearbeiten` | Bearbeiten | `assets/img/bearbeiten.png` | `record` → Datensatz bearbeiten<br>`dataform` → DataForm bearbeiten<br>`project` → Projekt bearbeiten |
| `loeschen` | Löschen | `assets/img/loeschen.png` | `record` → Datensatz löschen<br>`dataform` → DataForm löschen<br>`project` → Projekt löschen<br>`filter` → Filter löschen |
| `speichern` | Änderungen speichern | `assets/img/speichern.png` | `record` → Datensatz speichern<br>`filter` → Filter speichern<br>`settings` → Einstellungen speichern |
| `abbrechen` | Vorgang abbrechen | `assets/img/abbrechen.png` | – |
| `anzeigen` | Anzeigen | `assets/img/anzeigen.png` | `record` → Datensatz anzeigen<br>`project` → Projekt anzeigen |
| `kopieren` | Kopieren | `assets/img/kopieren.png` | – |
| `duplizieren` | Duplizieren | `assets/img/duplizieren.png` | – |
| `schliessen` | Ansicht schließen | `assets/img/schliessen.png` | – |
| `mehr` | Weitere Aktionen anzeigen | `assets/img/mehr.png` | – |
| `suchen` | Suchen | `assets/img/suchen.png` | – |
...
| `tabelle` | Tabellenansicht öffnen | `assets/img/tabelle.png` | – |
| `formular` | Formular öffnen | `assets/img/formular.png` | `dataform` → DataForm öffnen |
...
| `normaler_ds` | Datensatz auswählen | `assets/img/normaler_ds.png` | `dataform_records` → Datensätze öffnen |
| `auswaehlen` | Auswählen | `assets/img/auswaehlen.png` | – |
...
| `lookup` | Referenz auswählen | `assets/img/lookup.png` | – |
...
| `warnung` | Warnhinweis anzeigen | `assets/img/warnung.png` | – |
| `bestaetigen` | Aktion bestätigen | `assets/img/bestaetigen.png` | – |
| `start` | Startseite öffnen | `assets/img/start.png` | – |
