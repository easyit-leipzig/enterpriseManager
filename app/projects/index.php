...
?>
<section class="hero">
    <span class="badge">Projektverwaltung · HF73</span>
    <h1>Projekte</h1>
    <p>Alle easyIT-Projekte werden zentral verwaltet. Öffnen, bearbeiten und entfernen Sie Projekte direkt aus der Liste.</p>
    <div class="actions">
        ...
        <table class="project-table">
            ...
            <?php foreach ($projects as $p): ?>
                <tr>
                    ...
                    <td><code><?= e((string)$p['database_name']) ?></code></td>
                    <td><?= e((string)$p['status']) ?></td>
                    <td><?= e((string)$p['updated_at']) ?></td>
                    <td>
                        <div class="project-crud-actions" aria-label="Aktionen für <?= e((string)$p['name']) ?>">
                            <a class="button" data-crud="read" href="view.php?id=<?= (int)$p['id'] ?>">Öffnen</a>
                            <a class="button" data-crud="edit" href="edit.php?id=<?= (int)$p['id'] ?>">Bearbeiten</a>
                            ...
                            <a class="button" data-crud="delete" href="delete.php?id=<?= (int)$p['id'] ?>">Löschen</a>
                        </div>
                    </td>
                </tr>
            <?php endforeach; ?>
